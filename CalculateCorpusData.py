...
from tkinter import Tk, Button, CENTER, filedialog
...
def command():
    corpora_path = filedialog.askdirectory()
    pb['value'] += 20
    ...
    new_path = 'Result_of_Corpus_Data'
...
if __name__ == '__main__':
    ...
    app.title("Calculate Corpus Data app - Step 3/3")

    command_button = Button(app, text="Calculate Corpus Data", command=command)
